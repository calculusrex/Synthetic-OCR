...
from bounding_box import vector_add, random_vector__pixels, word_data_2_bounding_boxes, integrate_bounding_boxes_into_word_data
...
def adjust_bitmap_n_word_data_margins(bitmap, word_data, left_x, upper_y, right_x, lower_y, fill=(0, 0, 0, 0)):
